...
def main():
    ...
    for gen in range(1, args.generations + 1):
        ...
        mother_wr = pool[0][0] if pool[0][2] == "MADRE" else mother_wr
        ...
        print(
            f"  >> MEJOR GEN {gen}: win-rate {best_wr * 100:.1f}%  "
    ...
    print(
        f"  win-rate global: {best_overall_wr * 100:.1f}%  ({Path(best_overall_path).name})"
    )
